  ...
  return (
    <div className="space-y-12 sm:space-y-16 animate-in fade-in duration-1000">
      ...
      <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-12 px-4">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-display text-white mb-4 sm:mb-6 tracking-widest drop-shadow-md font-bold">
          대륙의 규율
        </h2>
        <div className="w-16 sm:w-24 h-px bg-[#d4af37]/30 mx-auto mb-6 sm:mb-8"></div>
        <p className="text-stone-300 font-serif text-base sm:text-lg leading-relaxed break-keep">
      ...
      <div className="grid lg:grid-cols-2 gap-6 sm:gap-10">
        <section className="relative p-6 sm:p-8 md:p-12 border border-stone-800 shadow-xl overflow-hidden group">
          ...
          <div className="relative z-10">
            <h2 className="text-xl sm:text-2xl font-serif text-white flex items-center gap-3 sm:gap-4 mb-8 sm:mb-10 pb-3 sm:pb-4 border-b border-stone-800 font-bold tracking-wide">
              <Crosshair className="w-5 h-5 sm:w-6 sm:h-6 text-[#d4af37]" /> 6대 스탯 능력
            </h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-6">
              {stats.map(stat => (
                <div key={stat.id} className="text-center group/stat border border-transparent hover:border-[#d4af37]/30 p-3 sm:p-4 transition-all bg-black/60 backdrop-blur-sm">
                  <div className="text-3xl sm:text-4xl mb-2 sm:mb-3 grayscale opacity-80 group-hover/stat:grayscale-0 group-hover/stat:opacity-100 transition-all">{stat.emoji}</div>
                  <div className="font-serif font-bold text-stone-300 tracking-widest group-hover/stat:text-white transition-colors text-sm sm:text-lg">{stat.name}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="relative p-6 sm:p-8 md:p-12 border border-stone-800 shadow-xl overflow-hidden group">
          ...
          <div className="relative z-10">
            <h2 className="text-xl sm:text-2xl font-serif text-white flex items-center gap-3 sm:gap-4 mb-8 sm:mb-10 pb-3 sm:pb-4 border-b border-stone-800 font-bold tracking-wide">
              <Shield className="w-5 h-5 sm:w-6 sm:h-6 text-[#d4af37]" /> 명예와 진급
            </h2>
          <div className="space-y-6 sm:space-y-8">
            <div>
              <h3 className="text-sm sm:text-base font-serif text-[#d4af37] tracking-widest mb-3 font-bold border-l-2 border-[#d4af37] pl-3">경험치 및 성장</h3>
              <p className="text-stone-300 font-serif text-xs sm:text-sm leading-relaxed text-justify bg-black/40 p-4 border border-stone-800 break-keep">
            ...
            <div>
              <h3 className="text-sm sm:text-base font-serif text-[#d4af37] tracking-widest mb-3 sm:mb-4 flex flex-col sm:flex-row sm:items-center justify-between font-bold border-l-2 border-[#d4af37] pl-3 gap-1">
                <span>가문 등급 (Tier)</span>
                <span className="text-stone-500 text-[10px] sm:text-xs text-left sm:text-right normal-case tracking-normal font-normal">증가: 전투 승리 / 외교 성공<br className="hidden sm:block"/>하락: 무단 약탈 / 배신 / 패전</span>
              </h3>
              <ul className="space-y-3 font-serif bg-black/40 p-3 sm:p-4 border border-stone-800">
      ...
      <section className="bg-[url('https://i.postimg.cc/9FNLmccL/jemog-eobsneun-dijain.png')] bg-cover bg-center border border-stone-800 relative overflow-hidden group mt-12 sm:mt-16">
        ...
        <div className="flex flex-col md:flex-row relative z-10 divide-y md:divide-y-0 md:divide-x divide-stone-800">
          ...
          <div className="flex-1 p-6 sm:p-10 md:p-16">
            <div className="mb-4 sm:mb-6 flex items-center justify-between">
              <h3 className="text-2xl sm:text-3xl font-display text-rose-800 tracking-widest font-bold">NPC</h3>
              <div className="text-xs sm:text-sm font-serif tracking-widest text-[#d4af37] border border-[#d4af37]/50 px-2 sm:px-3 py-1 bg-[#d4af37]/10 font-bold">철과 피의 규율</div>
            </div>
            <p className="text-base sm:text-lg text-stone-200 font-serif mb-4 sm:mb-6 leading-relaxed break-keep">
              "마법, 이능력 따위는 시정잡배들의 음유시일 뿐이다. 검과 책략만이 권력을 쟁취하는 유일한 수단이다."
            </p>
            <p className="text-sm text-stone-400 font-serif leading-relaxed break-keep">
          ...
          <div className="flex-1 p-6 sm:p-10 md:p-16">
            <div className="mb-4 sm:mb-6 flex items-center justify-between">
              <h3 className="text-2xl sm:text-3xl font-display text-emerald-700 tracking-widest font-bold">Player</h3>
              <div className="text-xs sm:text-sm font-serif tracking-widest text-[#d4af37] border border-[#d4af37]/50 px-2 sm:px-3 py-1 bg-[#d4af37]/10 font-bold whitespace-nowrap">구속받지 않는 자</div>
            </div>
            <p className="text-base sm:text-lg text-stone-200 font-serif mb-4 sm:mb-6 leading-relaxed break-keep">
